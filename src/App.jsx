...
function App() {
  const [question, setQuuestion] = useState("");
  ...
  return (
    <>
      <div className={darkMode == "dark" ? "dark" : "ligth"}>
        <div className="grid grid-cols-5 h-screen text-center">
          ...
          <div className="col-span-4 p-10">
            <h1 className="text-4xl bg-clip-text text-transparent bg-gradient-to-r from-pink-600 to-violet-700">
            ...
            <div ref={scrollToAns} className="container h-130 overflow-scroll">
            ...
            <form onSubmit={askQuestion}>
              <div className="dark:bg-zinc-800 w-1/2 p-1 pr-5 dark:text-white bg-white text-zinc-800 m-auto rounded-4xl border border-zinc-700 flex h-16">
                <input
                  ...
                  value={question}
                  // onKeyDown={isEnter}
                  onChange={(event) => setQuuestion(event.target.value)}
